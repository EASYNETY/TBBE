...
export class WalletController {
  ...
  async confirmDeposit(req: AuthRequest, res: Response): Promise<void> {
    try {
      if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
  ...
  async transferBetweenWallets(req: AuthRequest, res: Response): Promise<void> {
    try {
      if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
  ...
  async withdrawToExternalWallet(req: AuthRequest, res: Response): Promise<void> {
    try {
      if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
  ...
  async getWithdrawalStatus(req: AuthRequest, res: Response): Promise<void> {
    try {
      if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
  ...
  async getWithdrawalLimits(req: AuthRequest, res: Response): Promise<void> {
    try {
      if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
  ...
  async getWithdrawalFees(req: AuthRequest, res: Response): Promise<void> {
    try {
      const fees = {
  ...
  async linkExternalWallet(req: AuthRequest, res: Response): Promise<void> {
    try {
      if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
  ...
  async getLinkedWallets(req: AuthRequest, res: Response): Promise<void> {
    try {
      if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
      ...
      res.json({
        success: true,
        wallets: linkedWallets.map((w: any) => ({
          id: w.id,
