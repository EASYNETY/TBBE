 ...
 */
export async function createWalletFlowTables(pool: Pool): Promise<void> {
  ...
  try {
    ...
    const checkWalletColumns = await connection.query(
...
export async function seedWalletFlowData(pool: Pool): Promise<void> {
